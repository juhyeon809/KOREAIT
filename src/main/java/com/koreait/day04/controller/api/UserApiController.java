package com.koreait.day04.controller.api;

import com.koreait.day04.controller.CrudController;
...
import com.koreait.day04.service.UserApiLogicService;
...
//    }
    ...
    @Override
    @DeleteMapping("{id}") //http://localhost:8080/api/user/ (delete)
    public Header<UserApiResponse> delete(@PathVariable Long id) {
        return userApiLogicService.delete(id);
    }

    @GetMapping("") ///http://localhost:8080/api/user?page=1
    ...
    @GetMapping("/{id}/orderInfo") //http://localhost:8080/api/user/41/orderInfo
